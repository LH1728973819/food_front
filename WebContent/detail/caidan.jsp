	...
	<div id="all">
		<div id="menu">
			...
			<div id="top">
				<ul>
					<!-- 循环列出餐品 -->
					<c:forEach var="l" items="${requestScope.listFood.data}">
						<li>
							<dl>                                                                                                                                      
								<dt>
									<a href="${pageScope.request.contextPath }caixiangxi.jsp">
										<img width="214px" height="145px" src="${pageContext.request.contextPath}image?imageName=${pageScope.l.PICTURE}" />
									</a>
								</dt>
								<dd class="f1">
									<a href="caixiangxi.html">${pageScope.l.FOODNAME}</a>
								</dd>
								<dd class="f2">
									<a href="caixiangxi.html">&yen;${pageScope.l.PRICE}</a>
								</dd>
							</dl>
						</li>
					</c:forEach>
		...
		<div id="dish_class">
			...
			<div id="dish_2">
				<ul>
					<c:forEach var="u" items="${requestScope.listFoodType}">
						<li>
							<a href="chuancai.html">${pageScope.u.TYPENAME}</a>
						</li>
					</c:forEach>
				</ul>
			</div>
